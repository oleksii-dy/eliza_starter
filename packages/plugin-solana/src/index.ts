...
import { mintNftAction, transferNftAction, listNftAction, viewNftsAction } from './actions/nft.js';
...
import { Token22Service } from './services/Token22Service.js';
import { MultiSigService } from './services/MultiSigService.js';
import { TransactionHistoryService } from './services/TransactionHistoryService.js';
import { SolanaUniversalWalletService } from './services/SolanaUniversalWalletService.js';
import { walletProvider } from './providers/wallet.js';
import { validateSolanaConfig, generateConfigTemplate } from './utils/configValidator.js';
...
const solanaPlugin: Plugin = {
    ...
    description: 'Core Solana blockchain integration with wallet management, transfers, swaps, and staking.',
    actions: [
        executeSwap,
        transferAction,
        stakeSOL,
