...
const getTestAddresses = () => TEST_ADDRESSES[NETWORK as keyof typeof TEST_ADDRESSES] || TEST_ADDRESSES.devnet;
...
describe(`Solana Plugin Integration Tests - ${NETWORK}`, () => {
    ...
    beforeAll(async () => {
        ...
        mockRuntime = {
            ...
            getService: (serviceType: string) => {
                if (serviceType === 'rpc-service') return rpcService;
                return null;
            }
        };
    ...
    describe('RPC Service Integration', () => {
        it('should connect to the network and get status', async () => {
        ...
        it('should get network slot information', async () => {
    ...
    describe('Wallet Balance Service Integration', () => {
        it('should fetch SOL balance for a real address', async () => {
        ...
        it('should handle multiple wallet balance requests', async () => {
            const addresses = [
    ...
    describe('Token Service Integration', () => {
        it('should fetch token metadata for well-known tokens', async () => {
        ...
        it('should fetch SOL token metadata', async () => {
            const addresses = getTestAddresses();
    ...
    describe('Price Oracle Service Integration', () => {
        ...
        it('should fetch USDC price and identify as stable', async () => {
            const addresses = getTestAddresses();
    ...
    describe('Custodial Wallet Service Integration', () => {
        ...
        it('should create custodial wallets for different entities', async () => {
            // Create user wallet
        ...
        it('should manage wallet permissions correctly', async () => {
            const delegateId = 'delegate-user-' + Date.now();

            // Grant read permission
            await custodialService.grantPermission(
                testRoomId,
                delegateId,
                ['read'],
                testUserId
        ...
        it('should get wallet balances on the actual network', async () => {
        ...
        it('should export wallet data securely', async () => {
        ...
        it('should manage wallet lifecycle operations', async () => {
            // Update metadata
        ...
        it('should list wallets by owner and type', async () => {
    ...
    describe('Transaction Service Integration', () => {
        it('should estimate priority fees', async () => {
        ...
        it('should simulate transactions without executing', async () => {
            ...
            const simulationResult = await transactionService.simulateTransaction(transaction, [testKeypair]);
    ...
    describe('Network-specific behavior', () => {
        it('should handle network-specific token lists', async () => {
