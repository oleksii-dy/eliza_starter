...
export class Token22Service extends Service {
   ...
   * Mint Token22 tokens
   */
  async mintToken22(mint: PublicKey, destination: PublicKey, amount: bigint): Promise<string> {
   ...
   */
  private calculateTransferFee(amount: bigint, feeBasisPoints: number, maximumFee: bigint): bigint {
   ...
   */
  async getToken22Accounts(owner: PublicKey): Promise<
    Array<{
      mint: PublicKey;
      account: PublicKey;
      balance: bigint;
