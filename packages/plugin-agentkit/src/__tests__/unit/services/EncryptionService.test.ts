...
describe('EncryptionService', () => {
    ...
    describe('constructor and setPassphrase', () => {
        ...
        it('should reject short passphrases', () => {
            service = new EncryptionService();
            expect(() => service.setPassphrase('short')).toThrow('Passphrase must be at least 12 characters long');
        });

        it('should reject empty passphrases', () => {
            service = new EncryptionService();
            expect(() => service.setPassphrase('')).toThrow('Passphrase must be at least 12 characters long');
        });
    });
