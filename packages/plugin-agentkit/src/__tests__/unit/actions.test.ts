...
describe('AgentKit Actions', () => {
    ...
    describe('createAgentKitActionsFromService', () => {
        ...
        it('should handle errors gracefully', async () => {
            ...
            await expect(createAgentKitActionsFromService(mockRuntime)).rejects.toThrow('AgentKit not available');
        });
    });
    ...
    describe('Created Action Behavior', () => {
        ...
        it('should handle action invocation errors', async () => {
            ...
            mockAgentKitService.getAgentKit().getActions()[0].invoke.mockRejectedValue(
            ...
            const result = await getBalanceAction.handler(mockRuntime, mockMessage, mockState, {}, mockCallback);
