    ...
    tests = [
        ...
        },
        {
            ...
            fn: async (runtime: any) => {
                ...
                if (!agentKitService) {
                    console.warn("⚠️  AgentKit service not available - CDP credentials may not be configured");
        ...
        },
        {
            ...
            fn: async (runtime: any) => {
                ...
                if (!walletService) {
                    console.warn("⚠️  Custodial wallet service not available - encryption passphrase may not be configured");
                    // This is not a failure - the service is optional
                    return;
                }
        ...
        },
        {
            ...
            fn: async (runtime: any) => {
                ...
                const agentKitActions = actions.filter((a: any) => 
