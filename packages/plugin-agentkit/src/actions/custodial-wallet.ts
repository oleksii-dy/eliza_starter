...
export const createCustodialWalletAction: Action = {
    ...
    description: "Create a new custodial wallet for users, rooms, or worlds with trust-based access control",
    
    validate: async (runtime: IAgentRuntime, message: Memory) => {
        const custodialService = runtime.getService<CustodialWalletService>("custodial-wallet");
        if (!custodialService) return false;

        const text = message.content.text?.toLowerCase() || "";
        const keywords = ["create wallet", "new wallet", "setup wallet", "make wallet", "custodial wallet"];
        ...
        [
            ...
            },
            {
                ...
                content: {
                    ...
                    thought: "User wants a custodial wallet for DeFi. I'll create one with appropriate trust levels and DeFi purpose.",
        ...
        [
            ...
            },
            {
                ...
                content: {
                    ...
                    thought: "User wants a pool wallet for the room. I'll create a custodial wallet associated with this room.",
                    actions: ["CREATE_CUSTODIAL_WALLET"],
                },
            },
        ],
...
export const listCustodialWalletsAction: Action = {
    ...
    handler: async (
        ...
        try {
            ...
            const roomWallets = message.roomId ? await custodialService.getWalletsForRoom(message.roomId) : [];
        ...
        [
            ...
            },
            {
                ...
                content: {
                    ...
                    thought: "User wants to see their custodial wallets. I'll list both personal and room wallets.",
        ...
        [
            ...
            },
            {
                ...
                content: {
                    ...
                    thought: "User wants to transfer wallet ownership. I need to verify they have admin permissions and execute the transfer.",
        ...
        [
            ...
            },
            {
                ...
                content: {
                    ...
                    thought: "User wants to add a controller to their wallet. I need to verify admin permissions and add the controller.",
 ...
 */
async function extractWalletParams(text: string, message: Memory, state?: State): Promise<{
    name?: string;
    description?: string;
    entityId?: UUID;
    roomId?: UUID;
...
async function extractTransferParams(text: string, message: Memory, state?: State): Promise<{
    walletId?: UUID;
    newOwnerId?: UUID;
}> {
    const params: any = {};
    ...
    const walletMatch = text.match(/wallet\s+([a-zA-Z0-9-]+)/i) || 
                       text.match(/wallet\s*([a-zA-Z0-9-]+)/i);
    if (walletMatch) {
...
async function extractControllerParams(text: string, message: Memory, state?: State): Promise<{
    walletId?: UUID;
    controllerId?: UUID;
}> {
    const params: any = {};
