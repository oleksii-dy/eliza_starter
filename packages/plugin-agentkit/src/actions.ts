        ...
        [
            ...
            },
            {
                ...
                content: {
                    ...
                    thought: "User wants to lend on Compound but needs balance check first. This is a perfect action chain scenario.",
                    actions: ["GET_BALANCE"],
                },
            },
        ],
        ...
        [
            ...
            },
            {
                ...
                content: {
                    ...
                    thought: "User wants to send half their USDC. I need to check balance first, calculate half, then transfer.",
                    actions: ["GET_BALANCE"],
                },
            },
        ],
        ...
        [
            ...
            },
            {
                ...
                content: {
                    ...
                    thought: "User wants to supply USDC to Compound for lending. This is a straightforward supply operation.",
        ...
        [
            ...
            },
            {
                ...
                content: {
                    ...
                    thought: "User wants to supply all USDC. I need to check balance first to know the amount, then supply.",
                    actions: ["GET_BALANCE"],
                },
            },
        ],
        ...
        [
            ...
            },
            {
                ...
                content: {
                    ...
                    thought: "User wants to create a leveraged position. First supply ETH, then borrow USDC. This is a multi-step DeFi strategy.",
                    actions: ["CDP_COMPOUND_SUPPLY"],
                },
            },
        ],
        ...
        [
            ...
            },
            {
                ...
                content: {
                    ...
                    thought: "User wants to wrap ETH then use it for DeFi. I need to wrap first, then supply to Compound.",
                    actions: ["CDP_WRAP_ETH"],
                },
            },
        ],
        ...
        [
            ...
            },
            {
                ...
                content: {
                    ...
                    thought: "User has a two-step strategy: trade USDC to ETH, then supply ETH for yield. This requires action chaining.",
                    actions: ["CDP_TRADE"],
                },
            },
        ],
        ...
        [
            ...
            },
            {
                ...
                content: {
                    ...
                    thought: "User wants to share their DeFi achievement on Twitter. I'll compose and post a tweet.",
                    actions: ["POST_TWEET"],
                },
            },
        ],
        ...
        [
            ...
            },
            {
                ...
                content: {
                    ...
                    thought: "User wants to do DeFi action and share it socially. Supply to Compound first, then post tweet.",
                    actions: ["CDP_COMPOUND_SUPPLY"],
                },
            },
        ],
        ...
        [
            ...
            },
            {
                ...
                content: {
                    ...
                    thought: "User wants conditional trading based on price. Check price first, then potentially execute trade.",
                    actions: ["PYTH_FETCH_PRICE"],
                },
            },
        ],
        ...
        [
            ...
            },
            {
                ...
                content: {
                    ...
                    thought: "User wants cross-chain yield farming. Bridge to Base first, then supply to Compound there.",
                    actions: ["CDP_ACROSS_BRIDGE"],
                },
            },
        ],
        ...
        [
            ...
            },
            {
                ...
                content: {
                    ...
                    thought: "User wants portfolio analysis. I need to check balances, Compound positions, and calculate overall performance.",
    ...
    const actions = agentKitActions.map((agentKitAction: any) => {
        ...
        return {
            ...
            validate: async (runtime: IAgentRuntime, message: Memory, state?: State) => {
                ...
                return actionKeywords.some(keyword => messageText.includes(keyword)) ||
        ...
        handler: async (
            ...
            try {
                ...
                const parameters = await extractParametersFromMessage(agentKitAction, messageText, currentState);
 ...
 */
async function extractParametersFromMessage(action: any, messageText: string, state?: State): Promise<unknown> {
    ...
    try {
        ...
        if (schema && schema._def) {
            ...
            const enhancedParams = enhanceParametersForTool(actionName, params, messageText, state);
        ...
        console.log(`[AgentKit] Could not parse parameters for ${actionName}:`, error);
    }

    // Fallback to enhanced parameters
    return enhanceParametersForTool(actionName, params, messageText, state);
}
 ...
 */
function enhanceParametersForTool(toolName: string, params: Record<string, any>, messageText: string, state?: State): Record<string, any> {
    ...
    switch (toolName) {
        case "transfer":
            ...
            const addressMatch = messageText.match(/(0x[a-fA-F0-9]{40}|[a-zA-Z0-9.-]+\.eth|[a-zA-Z0-9.-]+\.base\.eth)/i);
            if (addressMatch) {
 ...
 */
async function getChainContext(agentKitService: AgentKitService): Promise<string | undefined> {
    try {
...
function categorizeAction(toolName: string): string {
    if (toolName.includes('balance') || toolName.includes('transfer')) return 'wallet';
    if (toolName.includes('compound') || toolName.includes('supply') || toolName.includes('borrow')) return 'defi';
    if (toolName.includes('trade') || toolName.includes('swap')) return 'trading';
    if (toolName.includes('tweet') || toolName.includes('cast')) return 'social';
    if (toolName.includes('nft') || toolName.includes('mint')) return 'nft';
    if (toolName.includes('price') || toolName.includes('pyth')) return 'data';
    if (toolName.includes('bridge') || toolName.includes('across')) return 'bridge';
    return 'other';
}
