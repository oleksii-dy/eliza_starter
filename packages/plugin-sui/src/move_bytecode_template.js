/**
 * This is a copy of @mysten/move-bytecode-template/move_bytecode_template.js
 * The original package has issues with direct imports
 * Original package: https://www.npmjs.com/package/@mysten/move-bytecode-template
 * Version: 0.1.0
 *
 */
...
async function __wbg_init(input) {
    ...
    if (typeof input === 'undefined') {
        input = new URL('move_bytecode_template_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
