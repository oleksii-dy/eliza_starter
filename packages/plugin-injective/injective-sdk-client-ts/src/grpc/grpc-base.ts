...
//TODO: move to rest base import
  ...
  export type RequestMethod<TRequest, TResponse> = (request: TRequest) => Promise<TResponse>;
  ...
  export class InjectiveGrpcBase {
    ...
    protected readonly indexerGrpcCampaignApi: IndexerGrpcCampaignApi;
    ...
    constructor(
      ...
      this.chainGrpcDistributionApi = new ChainGrpcDistributionApi(this.endpoints.grpc);
      ...
      this.chainGrpcInsuranceFundApi = new ChainGrpcInsuranceFundApi(this.endpoints.grpc);
      ...
      this.chainGrpcPermissionsApi = new ChainGrpcPermissionsApi(this.endpoints.grpc);
      this.chainGrpcStakingApi = new ChainGrpcStakingApi(this.endpoints.grpc);
      this.chainGrpcTendermintApi = new ChainGrpcTendermintApi(this.endpoints.grpc);
      this.chainGrpcTokenFactoryApi = new ChainGrpcTokenFactoryApi(this.endpoints.grpc);
      ...
      this.indexerGrpcAccountApi = new IndexerGrpcAccountApi(this.endpoints.indexer);
      this.indexerGrpcArchiverApi = new IndexerGrpcArchiverApi(this.endpoints.indexer);
      this.indexerGrpcAuctionApi = new IndexerGrpcAuctionApi(this.endpoints.indexer);
      this.indexerGrpcCampaignApi = new IndexerGrpcCampaignApi(this.endpoints.indexer);
      this.indexerGrpcDerivativesApi = new IndexerGrpcDerivativesApi(this.endpoints.indexer);
      this.indexerGrpcExplorerApi = new IndexerGrpcExplorerApi(this.endpoints.indexer);
      this.indexerGrpcInsuranceFundApi = new IndexerGrpcInsuranceFundApi(this.endpoints.indexer);
      this.indexerGrpcMitoApi = new IndexerGrpcMitoApi(this.endpoints.indexer);
      this.indexerGrpcOracleApi = new IndexerGrpcOracleApi(this.endpoints.indexer);
      ...
      this.indexerGrpcTradingApi = new IndexerGrpcTradingApi(this.endpoints.indexer);
      this.indexerGrpcWeb3GwApi = new IndexerGrpcWeb3GwApi(this.endpoints.indexer);
      ...
      this.chainRestTendermintApi = new ChainRestTendermintApi(this.endpoints.rest);
    ...
    protected async request<TRequest, TResponse>({
        ...
        try {
          ...
          throw new GrpcException(new Error('Unknown gRPC request error occurred'), UnspecifiedErrorCode, 'request');
        }
      }
    ...
    protected async query<TRequest, TResponse>({
        ...
        try {
          ...
          throw new GrpcException(new Error('Unknown gRPC query error occurred'), UnspecifiedErrorCode, 'query');
        }
      }
    /**
