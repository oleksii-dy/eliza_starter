...
export const crossmintPortfolioProvider: Provider = {
  ...
  description:
    'Provides comprehensive CrossMint portfolio data including token balances, asset valuations, DeFi positions, NFT holdings, and staked assets across multiple blockchain networks when agent needs to present wallet status or make informed investment decisions',
