...
export const transferAction = {
    ...
    handler: async (
        ...
        state.walletInfo = await vanaWalletProvider.get(
            runtime,
            message,
            currentState
        );
        ...
        const paramOptions: TransferParams = {
            ...
            data: content.data === null || content.data === "null" ? "0x" : content.data,
        };
        try {
        ...
        [
            {
                user: "{{user1}}",
                content: {
                    text: "Transfer 1 VANA to 0x742d35Cc6634C0532925a3b844Bc454e4438f44e",
                },
            },
            {
                user: "{{agent}}",
                content: {
                    text: "I'll help you transfer 1 VANA to 0x742d35Cc6634C0532925a3b844Bc454e4438f44e on Vana",
                    action: "TRANSFER",
                    content: {
                        chain: "vana",
                        token: "VANA",
