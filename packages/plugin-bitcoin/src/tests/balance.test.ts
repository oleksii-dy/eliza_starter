...
describe('balanceAction', () => {
  ...
  it('should return formatted balance with USD conversion', async () => {
    const result = await balanceAction.handler(mockRuntime, {} as any, {} as any, {}) as ActionResponse;
  ...
  it('should handle errors gracefully', async () => {
    ...
    const result = await balanceAction.handler(errorRuntime, {} as any, {} as any, {}) as ActionResponse;
    expect(result.text).toBe('Unable to fetch your Bitcoin balance at the moment. Please try again later.');
  });
});
