...
export const DEEPRESEARCH_BENCH: BenchmarkConfig = {
  ...
  description: 'PhD-level research across academic domains with complex, multi-faceted queries requiring deep analysis and synthesis',
  ...
  queries: [
    ...
    },
    {
      ...
      query: 'Evaluate the macroeconomic implications of central bank digital currencies (CBDCs) on monetary policy and financial stability',
      domain: 'economics',
      depth: 'phd_level',
      expectedSources: 22,
      maxDurationMs: 600000,
    ...
    },
    {
      ...
      query: 'Investigate current theories of machine consciousness and their relationship to human cognitive architectures',
      domain: 'psychology',
      depth: 'phd_level',
      expectedSources: 18,
      maxDurationMs: 600000,
    ...
    },
    {
      ...
      query: 'Assess the clinical efficacy and implementation challenges of precision oncology approaches in diverse patient populations',
      domain: 'medicine',
      depth: 'phd_level',
      expectedSources: 30,
      maxDurationMs: 600000,
    ...
    },
    {
      ...
      query: 'Analyze the current understanding of climate tipping points and their potential cascading effects on global systems',
    ...
    },
    {
      ...
      query: 'Explore the intersection of quantum computing and machine learning, focusing on near-term algorithmic advantages',
    ...
    },
    {
      ...
      query: 'Examine recent advances in brain-computer interfaces and their potential therapeutic applications for neurological disorders',
      domain: 'neuroscience',
      depth: 'phd_level',
      expectedSources: 28,
      maxDurationMs: 600000,
    ...
    },
    {
      ...
      query: 'Investigate the properties and potential applications of two-dimensional materials beyond graphene in next-generation electronics',
    ...
    },
    {
      ...
      query: 'Analyze the impact of social media algorithms on democratic discourse and political polarization in contemporary societies',
      domain: 'sociology',
      depth: 'phd_level',
      expectedSources: 21,
      maxDurationMs: 600000,
...
export const BREADTH_BENCH: BenchmarkConfig = {
  ...
  description: 'Research capabilities across diverse domains with moderate depth, testing versatility and domain knowledge',
  outputDir: '/Users/shawwalters/eliza-self/packages/docs/benchmarks',
  ...
  queries: [
    ...
    },
    {
      ...
      query: 'What is the current state of nuclear fusion energy development and commercial viability?',
      domain: 'energy',
      depth: 'deep',
      expectedSources: 14,
      maxDurationMs: 300000,
...
export const SPEED_BENCH: BenchmarkConfig = {
  ...
  description: 'Research efficiency with surface-level queries, focusing on rapid information retrieval and basic fact-finding',
  outputDir: '/Users/shawwalters/eliza-self/packages/docs/benchmarks',
...
export const ACCURACY_BENCH: BenchmarkConfig = {
  ...
  description: 'Factual accuracy and citation quality using well-established topics with clear documentation',
  outputDir: '/Users/shawwalters/eliza-self/packages/docs/benchmarks',
  ...
  queries: [
    {
      ...
      query: 'Analyze the current state, challenges, and future prospects of renewable energy adoption globally',
      domain: 'energy',
      depth: 'deep',
      expectedSources: 18,
    ...
    },
    {
      ...
      query: 'Examine blockchain governance mechanisms and their effectiveness in decentralized systems',
      domain: 'technology',
      depth: 'deep',
      expectedSources: 16,
      maxDurationMs: 480000,
