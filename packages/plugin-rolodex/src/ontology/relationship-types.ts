...
export const RELATIONSHIP_TYPES = {
  ...
  [RelationshipCategory.PERSONAL]: {
    FRIEND: {
      ...
      strengthFactors: ['interaction_frequency', 'emotional_support', 'shared_experiences', 'trust']
    },
    CLOSE_FRIEND: {
      id: 'close_friend',
      label: 'Close Friend',
    ...
    ROMANTIC_PARTNER: {
      ...
      patterns: ['partner', 'boyfriend', 'girlfriend', 'spouse', 'husband', 'wife', 'significant other'],
