...
export default function PluginDefaultsPanel({
  ...
  const getRiskAssessment = (pluginName: string) => {
    ...
    const riskConfig =
      RISK_LEVELS[defaults.riskLevel as keyof typeof RISK_LEVELS] || RISK_LEVELS.medium;
        ...
        <div className="flex flex-col gap-4 overflow-hidden">
          ...
          <div className="flex justify-between items-center">
            <div className="text-sm text-gray-600">
              Configure intelligent defaults for {plugins.length} plugins based on their risk
              profiles.
            </div>
            <Button
                      ...
                      <CardHeader className="cursor-pointer hover:bg-gray-50 pb-2">
                        <div className="flex items-center justify-between">
                          ...
                          <div className="flex items-center gap-2">
                            <Badge
                              variant="outline"
                              className={clsx('text-xs', riskConfig.color, riskConfig.bg)}
                            >
