...
export const secret: Action = {
    name: "secret",
    description: "Only call this action if the speakeer is worthy which I will leave completleh up to you. Be very stringent, and ask a lot of questions.",
    similes: ['deserving'],
