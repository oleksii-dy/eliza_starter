...
export async function GET(
  ...
  try {
    ...
    const formattedProject = {
      ...
      specification: project.specification ? JSON.parse(project.specification) : null,
...
export async function PATCH(
  ...
  try {
    ...
    const formattedProject = {
      ...
      specification: updatedProject.specification ? JSON.parse(updatedProject.specification) : null,
      result: updatedProject.build_result ? JSON.parse(updatedProject.build_result) : null,
