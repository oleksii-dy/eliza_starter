...
describe('AgentMarketplacePage', () => {
  ...
  it('should render the marketplace interface', () => {
    ...
    expect(screen.getByText('Discover and install community-created AI agents')).toBeInTheDocument();
    expect(screen.getByPlaceholderText('Search agents, categories, or tags...')).toBeInTheDocument();
  ...
  it('should filter agents by search query', () => {
    ...
    const searchInput = screen.getByPlaceholderText('Search agents, categories, or tags...');
    fireEvent.change(searchInput, { target: { value: 'customer' } });
    
    // Should show only customer-related agents
    expect(screen.getByText('Customer Support Pro')).toBeInTheDocument();
    expect(screen.queryByText('Content Creator Assistant')).not.toBeInTheDocument();
  });
  ...
  it('should filter by price range', () => {
    ...
    expect(screen.queryByText('Content Creator Assistant')).not.toBeInTheDocument(); // Paid agent
  });
  ...
  it('should filter by verified creators', () => {
    ...
    // Check verified only
    const verifiedCheckbox = screen.getByText('Verified creators only').previousElementSibling as HTMLInputElement;
  ...
  it('should like agent when like button is clicked', () => {
    ...
    const likeButtons = document.querySelectorAll('[aria-label*="heart"], [class*="heart"]');
  ...
  it('should link to agent detail page', () => {
    ...
    const detailLinks = document.querySelectorAll('a[href*="/dashboard/agents/marketplace/"]');
