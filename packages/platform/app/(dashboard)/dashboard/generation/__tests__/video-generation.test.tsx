...
describe('VideoGenerationPage', () => {
  ...
  it('should render the video generation interface', () => {
    ...
    expect(screen.getByText('Create dynamic videos from text descriptions')).toBeInTheDocument();
    expect(screen.getByPlaceholderText(/A serene mountain landscape/)).toBeInTheDocument();
  ...
  it('should update prompt when typing', () => {
    ...
    const promptInput = screen.getByPlaceholderText(/A serene mountain landscape/) as HTMLTextAreaElement;
    fireEvent.change(promptInput, { target: { value: 'A beautiful sunset over the ocean' } });
  ...
  it('should update motion prompt when typing', () => {
    ...
    const motionInput = screen.getByPlaceholderText(/Camera pans slowly/) as HTMLTextAreaElement;
    fireEvent.change(motionInput, { target: { value: 'Waves crash gently on the shore' } });
  ...
  it('should enable generate button when prompt is filled', () => {
    ...
    const promptInput = screen.getByPlaceholderText(/A serene mountain landscape/);
  ...
  it('should show empty state when no videos generated', () => {
    ...
    expect(screen.getByText('Enter a prompt above to start creating videos')).toBeInTheDocument();
  });
  ...
  it('should handle download button click', async () => {
    ...
    vi.spyOn(document, 'createElement').mockImplementation(() => mockAnchor as any);
