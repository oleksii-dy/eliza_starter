    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="mx-auto max-w-4xl px-6 py-12">
        <div className="prose prose-gray max-w-none">
          ...
          <p>
            By accessing or using the ElizaOS Platform ("Service"), you agree to be bound by 
          ...
          <p>
            ElizaOS Platform is a hosted service that enables developers to build, deploy, 
            and monetize AI agents using the ElizaOS framework. The Service includes:
          </p>
          <ul>
          ...
          <p>
            ...
            We are not liable for any loss resulting from unauthorized use of your credentials.
          </p>
          ...
          <h3>Your Content</h3>
          <p>
            You retain ownership of all content you create, upload, or store using the Service. 
            You grant us a limited license to host, store, and process your content to provide the Service.
          </p>

          <h3>Our Intellectual Property</h3>
          <p>
            The Service and all related technology, including the ElizaOS framework integration, 
            are protected by intellectual property laws. You may not copy, modify, or reverse 
            engineer our technology.
          </p>

          <h3>Third-Party Content</h3>
          <p>
            The Service may include content from third parties, including AI model providers. 
            Such content is subject to the respective third-party terms and licenses.
          </p>

          <h2>6. Payment and Billing</h2>
          <h3>Fees</h3>
          <p>
            Our Service operates on a pay-as-you-go model. You will be charged for actual usage 
            of AI models, storage, and premium features according to our published pricing.
          </p>
          ...
          <h3>Refunds</h3>
          <p>
            Refunds are generally not available for consumed services. We may provide refunds 
            or credits at our discretion for service outages or billing errors.
          </p>

          <h2>7. Service Availability</h2>
          <h3>Uptime Commitment</h3>
          <p>
            We strive to maintain 99.9% uptime for our core services. Scheduled maintenance 
          ...
          <p>
            ...
            We will provide reasonable notice for material changes affecting your use.
          </p>
          ...
          <p>
            ...
            backups of critical data and configurations.
          </p>
          ...
          <p>
            ...
            to conflict of law principles. Any disputes will be resolved in the courts of Delaware.
          </p>

          <h2>13. Changes to Terms</h2>
          <p>
            We may modify these Terms at any time. Material changes will be communicated via 
            email or platform notification. Continued use of the Service constitutes acceptance 
