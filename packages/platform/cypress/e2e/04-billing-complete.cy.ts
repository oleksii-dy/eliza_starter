...
describe('Billing & Payment Complete Management Test', () => {
  ...
  it('Billing Settings Page - Complete Layout Test', () => {
    ...
    cy.get('[data-cy="billing-title"]').should('be.visible').and('contain.text', 'Billing Settings');
    cy.get('[data-cy="billing-subtitle"]').should('be.visible').and('contain.text', 'payment methods');
    ...
    cy.get('[data-cy="payment-methods-title"]').should('be.visible').and('contain.text', 'Payment Methods');
    cy.get('[data-cy="add-payment-method"]').should('be.visible').and('contain.text', 'Add Payment Method');
    ...
    cy.get('[data-cy="auto-recharge-title"]').should('be.visible').and('contain.text', 'Auto-Recharge');
    
    // Test auto-recharge toggle
    cy.get('[data-cy="auto-recharge-toggle"]').should('be.checked');
    
    // Test threshold and amount inputs
    cy.get('[data-cy="auto-recharge-threshold"]').should('be.visible').and('have.value', '10');
    cy.get('[data-cy="auto-recharge-amount"]').should('be.visible').and('have.value', '50');
    ...
    cy.get('[data-cy="save-billing-settings"]').should('be.visible').and('contain.text', 'Save Billing Settings');
  ...
  it('Payment Methods - Add & Manage Test', () => {
    ...
    cy.get('[data-cy="payment-modal-title"]').should('be.visible').and('contain.text', 'Add Payment Method');
    ...
    // Test buttons
    cy.get('[data-cy="save-payment-method"]').should('be.visible').and('contain.text', 'Add Payment Method');
    cy.get('[data-cy="cancel-payment-method"]').should('be.visible').and('contain.text', 'Cancel');
  ...
  it('Billing Settings - Error Handling Test', () => {
    ...
    cy.intercept('GET', '**/api/v1/billing/settings', {
      ...
      body: {
        ...
        invoiceSettings: { frequency: 'monthly', autoDownload: false, emailCopy: false },
