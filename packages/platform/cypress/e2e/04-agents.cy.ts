describe('Agents Management - Complete Test Suite', () => {
  ...
  describe('Agents List Page', () => {
    ...
    it('should handle agent status indicators', () => {
      ...
      cy.get('[data-agent-id="agent-2"]').within(() => {
        cy.get('[data-cy="status-indicator"]').should('have.class', 'bg-gray-500')
  ...
  describe('Agent Creation Page', () => {
    ...
    it('should display agent creation form', () => {
      ...
      // Check create button
      cy.get('button[type="submit"]').contains('Create Agent').should('be.visible');
    });
    ...
    it('should handle agent creation', () => {
      ...
      cy.get('textarea[name="description"]').type('A test agent for Cypress testing');
  ...
  describe('Agent Editor', () => {
    ...
    it('should display agent editor interface', () => {
      ...
      cy.get('textarea[name="description"]').should('contain.value', 'Customer support agent');
    ...
    it('should handle system prompt editing', () => {
      ...
      cy.get('textarea[name="systemPrompt"]').should('be.visible')
        .clear()
        .type('You are an advanced customer support agent with expertise in technical issues.');
  ...
  describe('Error Handling and Edge Cases', () => {
    it('should handle empty agents list', () => {
      ...
      cy.contains('No agents found').should('be.visible')
    ...
    it('should handle API errors gracefully', () => {
      ...
      cy.contains('Error loading agents').should('be.visible')
  ...
  describe('Responsive Design and Accessibility', () => {
    ...
    it('should have proper ARIA labels', () => {
      ...
      cy.get('[data-cy="status-indicator"]').should('have.attr', 'aria-label')
        .or('have.attr', 'title');
      
      // Action buttons should have accessible names
      cy.get('button').contains('Start').should('have.attr', 'aria-label')
