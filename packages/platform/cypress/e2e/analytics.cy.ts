...
describe('Analytics Dashboard', () => {
  ...
  it('should display analytics dashboard correctly', () => {
    ...
    cy.contains('Monitor your AI inference usage, costs, and performance metrics').should('be.visible');
  ...
  it('should display provider breakdown', () => {
    ...
    cy.get('[data-testid="provider-item"]').first().within(() => {
  ...
  it('should open and configure markup percentage', () => {
    ...
    cy.intercept('POST', '/api/analytics/config', {
      statusCode: 200,
      body: { success: true, message: 'Markup percentage updated successfully' }
    }).as('updateConfig');
    ...
    cy.contains('Set the markup percentage applied to all AI inference costs').should('be.visible');
  ...
  it('should validate markup percentage input', () => {
    ...
    cy.contains('button', 'Update Markup').click();
    cy.contains('Please enter a valid percentage between 0 and 100').should('be.visible');
  ...
  it('should export analytics data', () => {
    ...
    cy.intercept('GET', '/api/analytics/export*', {
      ...
      headers: {
        ...
        'content-disposition': 'attachment; filename="analytics-daily-2025-01-25.csv"'
      },
