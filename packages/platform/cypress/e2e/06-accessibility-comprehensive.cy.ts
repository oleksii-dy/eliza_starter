...
describe('Accessibility Comprehensive Testing', () => {
  ...
  it('Dashboard - Accessibility Compliance Test', () => {
    ...
    cy.get('[data-cy="stats-agents"]').should('have.attr', 'role').or('have.attr', 'aria-label');
    ...
    cy.get('[data-cy="quick-action-create-agent"]').should('have.attr', 'href').and('be.visible');
    cy.get('[data-cy="quick-action-manage-api-keys"]').should('have.attr', 'href').and('be.visible');
  ...
  it('Authentication Forms - Accessibility Test', () => {
    ...
    cy.get('[data-cy="password-input"] label').should('exist').and('be.visible');
  ...
  it('Modal Dialogs - Accessibility Test', () => {
    ...
    cy.get('[data-cy="api-key-modal"]').should('have.attr', 'role', 'dialog')
  ...
  it('Interactive Elements - Accessibility Test', () => {
    ...
    cy.get('[data-cy="auto-recharge-toggle"]').should('have.attr', 'type', 'checkbox');
