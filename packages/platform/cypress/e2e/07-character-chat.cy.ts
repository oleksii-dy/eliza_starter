describe('Character Chat - Complete Test Suite', () => {
  ...
  describe('Characters List Page', () => {
    ...
    it('should display characters list correctly', () => {
      ...
      cy.get('[data-character-id="char-1"]').within(() => {
        cy.get('[data-cy="status-indicator"]').should('have.class', 'bg-green-500')
    ...
    it('should handle character avatars', () => {
      ...
      cy.get('[data-character-id="char-1"]').within(() => {
        cy.get('img[alt*="Support Assistant"]').should('be.visible')
          .and('have.attr', 'src').and('include', 'support.png');
      });
      
      cy.get('[data-character-id="char-2"]').within(() => {
        cy.get('img[alt*="Code Helper"]').should('be.visible')
          .and('have.attr', 'src').and('include', 'code.png');
      });
    });
    ...
    it('should handle create character button', () => {
      cy.get('button').contains('Create Character').should('be.visible').click();
  ...
  describe('Character Chat Interface', () => {
    ...
    it('should handle conversation selection', () => {
      ...
      cy.contains('Hello, I need help resetting my password').should('be.visible');
      cy.contains('I\'d be happy to help you reset your password').should('be.visible');
    ...
    it('should handle message formatting and markdown', () => {
      ...
      cy.intercept('GET', '**/characters/char-1/conversations/conv-formatted/messages', {
        statusCode: 200,
        body: {
          messages: [
            {
    ...
    it('should handle voice messages', () => {
      ...
      cy.get('textarea[placeholder*="Type your message"]')
        .should('have.value', 'This is a transcribed voice message');
    });
  });
  ...
  describe('Character Management', () => {
    ...
    it('should display character creation form', () => {
      ...
      // Check create button
      cy.get('button[type="submit"]').contains('Create Character').should('be.visible');
    });
    ...
    it('should handle character creation', () => {
      ...
      cy.get('textarea[name="description"]').type('A test character for Cypress testing');
      cy.get('textarea[name="systemPrompt"]').type('You are a helpful test assistant.');
    ...
    it('should handle character editing', () => {
      ...
      cy.get('textarea[name="description"]').should('contain.value', 'Helpful customer support agent');
  ...
  describe('Conversation Management', () => {
    ...
    it('should handle conversation renaming', () => {
      ...
      // Edit title
      cy.get('input[value="How to reset password"]').clear().type('Password Reset Help');
    ...
    it('should handle conversation export', () => {
      ...
      cy.intercept('GET', '**/characters/char-1/conversations/conv-1/export*', {
        ...
        headers: {
          ...
          'content-disposition': 'attachment; filename=conversation-conv-1.json'
        },
  ...
  describe('Error Handling and Edge Cases', () => {
    it('should handle character offline status', () => {
      ...
      cy.get('textarea[placeholder*="Type your message"]').should('be.disabled');
    ...
    it('should handle long conversations with pagination', () => {
      ...
      cy.intercept('GET', '**/characters/char-1/conversations/conv-long/messages*', {
        statusCode: 200,
        body: {
      ...
      cy.intercept('GET', '**/characters/char-1/conversations/conv-long/messages?cursor=cursor-50', {
        statusCode: 200,
        body: {
  ...
  describe('Responsive Design and Accessibility', () => {
    ...
    it('should support keyboard navigation', () => {
      ...
      cy.get('textarea[placeholder*="Type your message"]').focus().should('be.focused');
    });
