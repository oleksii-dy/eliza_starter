  ...
  tests = [
...

    {
      ...
      fn: async (runtime: any) => {
        ...
        const rssFiles = result.files.filter((f: any) => 
        ...
        const hasKeywordFiltering = result.files.some((f: any) =>
...

    {
      ...
      fn: async (runtime: any) => {
        ...
        const apiFiles = result.files.filter((f: any) => 
        ...
        const hasCaching = result.files.some((f: any) =>
        ...
        const hasErrorHandling = result.files.some((f: any) =>
...

    {
      ...
      fn: async (runtime: any) => {
        ...
        const hasTests = result.files.some((f: any) => 
