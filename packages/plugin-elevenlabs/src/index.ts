...
function getVoiceSettings(runtime: IAgentRuntime) {
  ...
  return {
    ...
    voiceId: getSetting('ELEVENLABS_VOICE_ID', 'NInYH8ezN1Ce0BM6aLUT'),
    model: getSetting('ELEVENLABS_MODEL_ID', 'eleven_multilingual_v2'),
    stability: getSetting('ELEVENLABS_VOICE_STABILITY', '0.75'),
    latency: getSetting('ELEVENLABS_OPTIMIZE_STREAMING_LATENCY', '0'),
    outputFormat: getSetting('ELEVENLABS_OUTPUT_FORMAT', 'pcm_16000'),
    similarity: getSetting('ELEVENLABS_VOICE_SIMILARITY_BOOST', '0.9'),
