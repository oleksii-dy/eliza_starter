...
const createTypedMockRuntime = (): IAgentRuntime => {
  ...
  // Override the agentId to ensure it's properly typed
  runtime.agentId = testAgentId;

  // Override useModel with a proper mock function
  runtime.useModel = vi.fn().mockResolvedValue('Mock response');
