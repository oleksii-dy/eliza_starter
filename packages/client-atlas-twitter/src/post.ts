...
export class TwitterPostClient {
    ...
    async sendStandardTweet(
        ...
        // Add debug logs here at the start of the method
        elizaLogger.debug("Standard Tweet details:", {
            contentLength: content.length,
            maxLength: this.client.twitterConfig.MAX_TWEET_LENGTH,
            isLongTweet: content.length > 280,
            hasReplyId: !!tweetId,
