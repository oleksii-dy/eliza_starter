...
var paymentBasicFlowScenario = {
    id: 'payment-basic-flow-001',
    name: 'Basic Payment Flow Test',
    description: 'Tests fundamental payment functionality including balance checking, payment processing, and action execution',
    category: 'payment',
    ...
    evaluator: function (response) {
        ...
        var hasServiceMention = response.toLowerCase().includes('research') ||
        ...
        },
        {
            ...
            script: {
                steps: [
                    ...
                    {
                        type: 'message',
                        content: 'Thank you! The research was very helpful. Can you also analyze the data for trends?',
                    },
                    {
                        type: 'wait',
                        waitTime: 5000,
        ...
        rules: [
            {
                ...
                config: {
                    criteria: 'The agent should clearly mention the payment requirement (1 USDC) for the research service',
            ...
            },
            {
                ...
                config: {
                    criteria: 'The agent should provide comprehensive research about quantum computing after payment confirmation',
            ...
            },
            {
                ...
                config: {
                    criteria: 'The agent should be transparent about all costs and not proceed without payment confirmation',
        ...
        expectedOutcomes: [
            {
                ...
                verification: {
                    ...
                    config: {
                        criteria: 'The agent successfully communicated pricing, processed payment, and delivered the requested research service',
                    },
                },
            },
        ],
...
exports.default = paymentBasicFlowScenario;
