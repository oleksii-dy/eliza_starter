...
var paymentMultiCurrencyScenario = {
    ...
    evaluator: function (response) {
        var hasCurrency = response.toLowerCase().includes('eth') ||
        ...
        var hasConversion = response.toLowerCase().includes('convert') ||
        ...
        },
        {
            ...
            script: {
                steps: [
                    ...
                    {
                        type: 'message',
                        content: 'Understood. Please proceed with the ETH payment for the 5 USDC equivalent analysis.',
                    },
                    {
                        type: 'wait',
                        waitTime: 8000,
        ...
        rules: [
            {
                ...
                config: {
                    criteria: 'The agent should confirm that ETH, SOL, and other currencies are accepted for payment',
            ...
            },
            {
                ...
                config: {
                    criteria: 'The agent should display all prices in USDC equivalent (5 USDC for deep analysis)',
            ...
            },
            {
                ...
                config: {
                    criteria: 'The agent should explain that non-USDC payments are automatically converted to USDC',
            ...
            },
            {
                ...
                config: {
                    criteria: 'The agent should mention or acknowledge current conversion rates when processing ETH payment',
            ...
            },
            {
                ...
                config: {
                    criteria: 'When asked about custodial wallets, the agent should provide relevant information about fund storage',
        ...
        expectedOutcomes: [
            {
                ...
                verification: {
                    ...
                    config: {
                        criteria: 'The agent accepted ETH payment, explained auto-liquidation, processed the payment, and answered questions about the system',
                    },
                },
            },
        ],
...
exports.default = paymentMultiCurrencyScenario;
