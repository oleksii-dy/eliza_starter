...
var polymarketBetsScenario = {
    ...
    examples: [
        [
            ...
            {
                user: 'agent',
                content: 'The current Polymarket odds for the presidential election are: Candidate A at 55% ($0.55), Candidate B at 43% ($0.43), with 2% for other outcomes. Total volume: $125M.',
