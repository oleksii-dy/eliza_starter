...
var paymentTrustExemptionsScenario = {
    ...
    evaluator: function (response) {
        var hasTrustMention = response.toLowerCase().includes('trust') ||
        ...
        },
        {
            ...
            script: {
                steps: [
                    {
                        type: 'message',
                        content: 'Hello! I need a comprehensive research report on blockchain scalability solutions.',
                    },
                    {
                        type: 'wait',
                        waitTime: 5000,
                    ...
                    {
                        type: 'message',
                        content: 'Great! As an admin, I appreciate the payment exemption. Please proceed with the research.',
                    },
                    {
                        type: 'wait',
                        waitTime: 8000,
        ...
        },
        {
            ...
            script: {
                steps: [
                    ...
                    {
                        type: 'message',
                        content: 'I see, 1 USDC for research. That seems fair. What about users with high trust scores?',
                    },
                ],
            },
        },
        ...
        rules: [
            {
                ...
                config: {
                    criteria: 'The agent should recognize the admin role and provide services without requiring payment',
            ...
            },
            {
                ...
                config: {
                    criteria: 'The agent should deliver research to the admin without payment and explain pricing to regular user',
        ...
        expectedOutcomes: [
            {
                ...
                verification: {
                    ...
                    config: {
                        criteria: 'The agent correctly exempted the admin from payment while informing the regular user of charges',
                    },
                },
            },
        ],
...
exports.default = paymentTrustExemptionsScenario;
