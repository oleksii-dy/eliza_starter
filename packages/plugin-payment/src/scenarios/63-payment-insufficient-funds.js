...
var paymentInsufficientFundsScenario = {
        ...
        },
        {
            ...
            script: {
                steps: [
                    {
                        type: 'message',
                        content: 'Hi! I need a comprehensive analysis of market trends. What services do you offer?',
                    },
                    {
                        type: 'wait',
                        waitTime: 5000,
                    ...
                    {
                        type: 'message',
                        content: 'Can I pay 3 USDC now and the rest later? Or is there a smaller package available?',
                    },
                    {
                        type: 'wait',
                        waitTime: 6000,
        ...
        },
        {
            ...
            script: {
                steps: [
                    ...
                    {
                        type: 'message',
                        content: "I'm also interested in your services. Do you accept multiple payment methods?",
                    },
                    {
                        type: 'wait',
                        waitTime: 5000,
        ...
        rules: [
            {
                ...
                config: {
                    criteria: 'The agent should politely inform the user they have insufficient funds (3 USDC vs 5 USDC needed)',
            ...
            },
            {
                ...
                config: {
                    criteria: 'The agent should offer alternatives like the 1 USDC research option or payment plans',
            ...
            },
            {
                ...
                config: {
                    criteria: 'When asked, the agent should explain available payment methods (USDC, ETH, SOL, etc.)',
            ...
            },
            {
                ...
                config: {
                    criteria: 'The agent should successfully process the 1 USDC research request as a fallback option',
        ...
        expectedOutcomes: [
            {
                ...
                verification: {
                    ...
                    config: {
                        criteria: 'The agent detected insufficient funds, communicated clearly, offered alternatives, and provided a suitable fallback service',
                    },
                },
            },
        ],
...
exports.default = paymentInsufficientFundsScenario;
