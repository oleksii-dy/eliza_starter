// Whitelabel ERC20 ABI for token deployment
// Based on Alethea AI's WhitelabelERC20 contract implementation
export const WHITELABEL_ERC20_ABI = [
  {
    inputs: [
  ...
  },
  {
    ...
    inputs: [
      ...
      { indexed: false, internalType: 'uint256', name: 'fromVal', type: 'uint256' },
      { indexed: false, internalType: 'uint256', name: 'toVal', type: 'uint256' },
    ],
