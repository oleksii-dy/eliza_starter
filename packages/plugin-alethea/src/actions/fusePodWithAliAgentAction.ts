    ...
    [
      {
        name: '{{user1}}',
        content: {
          text: 'Fuse pod 123 from contract 0xPodContract... with my ALI agent 0xAgentAddress...',
        },
      },
      {
        name: '{{user2}}',
        content: {
          text: 'Okay, attempting to fuse Pod 123 with ALI Agent 0xAgentAddress.... I will verify ownership and approval first.',
          actions: ['FUSE_POD_WITH_ALI_AGENT'],
        },
      },
    ],
    [
      {
        name: '{{user1}}',
        content: {
          text: 'Attach pod ID 789 to agent 0xAgentXYZ. The pod is at the default address.',
        },
      },
      {
        name: '{{user2}}',
        content: {
          text: 'Understood. Fusing Pod 789 (from default Pod contract) with ALI Agent 0xAgentXYZ...',
          actions: ['FUSE_POD_WITH_ALI_AGENT'],
        },
      },
    ],
