...
export const leaveHiveAction: Action = {
  name: 'LEAVE_HIVE',
  similes: ['UNLINK_ASSET', 'REMOVE_ASSET_FROM_HIVE', 'DISCONNECT_FROM_HIVE', 'UNLINK_FROM_HIVE'],
  ...
  examples: [
    [
      {
        name: '{{user1}}',
        content: { text: 'Unlink my NFT at contract 0x1234...5678 token ID 123 from its Hive.' },
      },
      {
        name: '{{user2}}',
        content: {
          text: 'I will unlink your NFT (contract 0x1234...5678, token 123) from its current Hive. Let me verify ownership and execute the unlinking.',
          actions: ['LEAVE_HIVE'],
        },
      },
    ],
    [
      { name: '{{user1}}', content: { text: "Remove my AI Pod 42 from whatever Hive it's in." } },
      {
        name: '{{user2}}',
        content: {
          text: 'Removing your AI Pod 42 from its current Hive.',
          actions: ['LEAVE_HIVE'],
        },
      },
    ],
    [
      {
        name: '{{user1}}',
        content: { text: 'Disconnect asset 999 from 0xabcd...ef from the Hive.' },
      },
      {
        name: '{{user2}}',
        content: { text: 'Disconnecting asset 999 from its Hive.', actions: ['LEAVE_HIVE'] },
      },
    ],
  ],
};
