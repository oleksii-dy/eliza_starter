  ...
  examples: [
    [
      { name: '{{user1}}', content: { text: 'Sell 10 keys for ALI agent 0xagentId123...xyz.' } },
      {
        name: '{{user2}}',
        content: {
          text: 'Okay, attempting to sell 10 keys for agent 0xagentId123...xyz. I will first check your balance and the current sell price.',
          actions: ['SELL_KEYS'],
        },
      },
    ],
    [
      { name: '{{user1}}', content: { text: 'I want to sell 1 key of agent 0xanotherAgentID.' } },
      {
        name: '{{user2}}',
        content: {
          text: 'Understood. Selling 1 key for agent 0xanotherAgentID.',
          actions: ['SELL_KEYS'],
        },
      },
    ],
