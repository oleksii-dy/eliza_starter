...
export const participateInVoteAction: Action = {
  ...
  examples: [
    [
      {
        name: '{{user1}}',
        content: { text: 'Vote on proposal 0xabc...def in space alethea-ai.eth with choice 1.' },
      },
      {
        name: '{{user2}}',
        content: { text: 'Casting your vote...', actions: ['PARTICIPATE_IN_VOTE'] },
      },
    ],
  ],
};
...
export const handleGovernanceErrorsAction: Action = {
  ...
  examples: [
    [
      {
        name: '{{user1}}',
        content: { text: 'I received a governance error with code 551. What does it mean?' },
      },
      {
        name: '{{user2}}',
        content: {
          text: 'Let me check the meaning of governance error 551 for you.',
          actions: ['HANDLE_GOVERNANCE_ERRORS'],
        },
      },
    ],
  ],
