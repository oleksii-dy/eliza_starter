...
export const getAliAgentKeySellPriceAction: Action = {
  ...
  examples: [
    [
      {
        name: '{{user1}}',
        content: { text: 'How much will I get for selling 1 key of agent 0x123...abc?' },
      },
      {
        name: '{{user2}}',
        content: { text: 'Fetching sell price...', actions: ['GET_ALI_AGENT_KEY_SELL_PRICE'] },
      },
    ],
    [
      {
        name: '{{user1}}',
        content: { text: 'Get sell price for 5 keys of ALI agent 0xdef...456.' },
      },
      {
        name: '{{user2}}',
        content: {
          text: 'Sure, let me check the sell price.',
          actions: ['GET_ALI_AGENT_KEY_SELL_PRICE'],
        },
      },
    ],
  ],
