...
export const createInftAction: Action = {
  name: 'CREATE_INFT',
  similes: ['GENERATE_INFT', 'MINT_INFT', 'FUSE_NFT_WITH_POD'],
  ...
  examples: [
    [
      {
        name: '{{user1}}',
        content: { text: 'Fuse my NFT 1 from 0x... with Pod 2 from 0x... and 50 ALI.' },
      },
      {
        name: '{{user2}}',
        content: { text: 'Initiating iNFT fusion...', actions: ['CREATE_INFT'] },
      },
    ],
  ],
};
