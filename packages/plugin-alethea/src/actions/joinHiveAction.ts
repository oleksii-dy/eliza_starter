...
export const joinHiveAction: Action = {
  name: 'JOIN_HIVE',
  similes: ['LINK_ASSET', 'ADD_ASSET_TO_HIVE', 'CONNECT_TO_HIVE', 'LINK_TO_HIVE'],
  ...
  examples: [
    [
      {
        name: '{{user1}}',
        content: { text: 'Link my NFT at contract 0x1234...5678 token ID 123 to Hive 456.' },
      },
      {
        name: '{{user2}}',
        content: {
          text: 'I will link your NFT (contract 0x1234...5678, token 123) to Hive 456. Let me verify ownership and execute the linking.',
          actions: ['JOIN_HIVE'],
        },
      },
    ],
    [
      {
        name: '{{user1}}',
        content: { text: 'Join Hive 789 with my AI Pod 42 from the standard contract.' },
      },
      {
        name: '{{user2}}',
        content: { text: 'Joining Hive 789 with your AI Pod 42.', actions: ['JOIN_HIVE'] },
      },
    ],
    [
      {
        name: '{{user1}}',
        content: { text: 'Add asset 999 from 0xabcd...ef to Hive 111 as category 2.' },
      },
      {
        name: '{{user2}}',
        content: { text: 'Adding asset 999 to Hive 111 with category 2.', actions: ['JOIN_HIVE'] },
      },
    ],
  ],
};
