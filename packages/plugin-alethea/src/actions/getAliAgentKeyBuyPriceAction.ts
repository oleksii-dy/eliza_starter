...
export const getAliAgentKeyBuyPriceAction: Action = {
  ...
  examples: [
    [
      {
        name: '{{user1}}',
        content: { text: 'How much does it cost to buy 1 key for agent 0x123...abc?' },
      },
      {
        name: '{{user2}}',
        content: { text: 'Fetching buy price...', actions: ['GET_ALI_AGENT_KEY_BUY_PRICE'] },
      },
    ],
    [
      {
        name: '{{user1}}',
        content: { text: 'Get buy price for 10 keys of ALI agent 0xdef...456.' },
      },
      {
        name: '{{user2}}',
        content: {
          text: 'Sure, getting that price for you.',
          actions: ['GET_ALI_AGENT_KEY_BUY_PRICE'],
        },
      },
    ],
    [
      {
        name: '{{user1}}',
        content: { text: "What's the buy price for agent 0xaaaa...cccc for 5 keys" },
      },
      {
        name: '{{user2}}',
        content: {
          text: 'Let me check the price for 5 keys of agent 0xaaaa...cccc.',
          actions: ['GET_ALI_AGENT_KEY_BUY_PRICE'],
        },
      },
    ],
