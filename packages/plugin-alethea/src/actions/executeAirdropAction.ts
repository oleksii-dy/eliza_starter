...
export const executeAirdropAction: Action = {
  ...
  similes: ['GENERIC_TOKEN_AIRDROP', 'SEND_TOKENS_BULK', 'TOKEN_AIRDROP'],
  description:
    ...
    [
      {
        name: '{{user1}}',
        content: {
          text: 'Airdrop 1000 tokens to 0x123...abc and 2000 to 0x456...def using token 0x789...ghi',
        },
      },
      {
        name: '{{user2}}',
        content: {
          text: 'Executing token airdrop to the specified recipients.',
          actions: ['EXECUTE_AIRDROP'],
        },
      },
    ],
    [
      {
        name: '{{user1}}',
        content: {
          text: 'Execute airdrop of tokens at 0xABC...DEF to address 0x111...222 (500 tokens).',
        },
      },
      {
        name: '{{user2}}',
        content: {
          text: 'Executing the token airdrop.',
          actions: ['EXECUTE_AIRDROP'],
        },
      },
    ],
    [
      {
        name: '{{user1}}',
        content: {
          text: 'I want to send my new "AwesomeToken" to a list of supporters. The token address is 0xaaa...bbb.',
        },
      },
      {
        name: '{{user2}}',
        content: {
          text: 'Okay, I can help with that. Please provide the list of recipients and amounts.',
          actions: ['EXECUTE_AIRDROP'],
        },
      },
    ],
    [
      {
        name: '{{user1}}',
        content: {
          text: 'Lets do a community airdrop. Token 0xccc...ddd, 25 tokens each to 0xeee...fff and 0xggg...hhh.',
        },
      },
      {
        name: '{{user2}}',
        content: {
          text: 'Got it. Initiating a community airdrop.',
          actions: ['EXECUTE_AIRDROP'],
        },
      },
    ],
