...
export const getAliAgentKeyMarketDataAction: Action = {
  ...
  similes: ['FETCH_KEY_PRICES', 'GET_KEY_MARKET_INFO'],
  ...
  examples: [
    [
      { name: '{{user1}}', content: { text: "Get market data for agent '0xabc...:123' on base." } },
      {
        name: '{{user2}}',
        content: {
          text: "Fetching market data for agent '0xabc...:123'...",
          actions: ['GET_MARKET_DATA'],
        },
      },
    ],
  ],
