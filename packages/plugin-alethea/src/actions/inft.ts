...
export const upgradeInftIntelligenceAction: Action = {
  ...
  similes: ['UPGRADE_INFT', 'LEVEL_UP_INFT', 'BOOST_INFT_INTELLIGENCE'],
  ...
  examples: [
    [
      { name: '{{user1}}', content: { text: 'Upgrade my iNFT 123 with 3000 ALI tokens.' } },
      {
        name: '{{user2}}',
        content: {
          text: 'Initiating intelligence upgrade for iNFT 123...',
          actions: ['UPGRADE_INFT_INTELLIGENCE'],
        },
      },
    ],
  ],
