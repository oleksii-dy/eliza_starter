...
export const deployHiveUtilityTokenAction: Action = {
  name: 'DEPLOY_HIVE_UTILITY_TOKEN',
  similes: [
    'CREATE_HIVE_TOKEN',
    ...
    [
      {
        name: '{{name1}}',
        content: {
          text: 'Deploy a utility token for Hive 0x789ghi with name "Hive Utility Token" symbol "HUT" and 2000000 initial supply',
        },
      },
      {
        name: '{{name2}}',
        content: {
          text: "I'll deploy a utility token for your Hive. This will create an ERC-20 token that can be used for Hive operations and governance.",
          action: 'DEPLOY_HIVE_UTILITY_TOKEN',
        },
      },
    ],
    [
      {
        name: '{{name1}}',
        content: {
          text: 'Create a token called "Community Token" with symbol "COM" for hive 0x999xyz, initial supply 1500000',
        },
      },
      {
        name: '{{name2}}',
        content: {
          text: "I'll create the Community Token (COM) for your Hive. This token will enable various utilities and governance features within your Hive.",
          action: 'DEPLOY_HIVE_UTILITY_TOKEN',
        },
      },
    ],
