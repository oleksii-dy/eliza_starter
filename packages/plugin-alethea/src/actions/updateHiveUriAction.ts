...
export const updateHiveUriAction: Action = {
  name: 'UPDATE_HIVE_URI',
  similes: ['SET_HIVE_URI', 'CHANGE_HIVE_URI', 'MODIFY_HIVE_URI', 'UPDATE_HIVE_METADATA'],
  ...
  examples: [
    [
      {
        name: '{{user1}}',
        content: { text: 'Update Hive 123 URI to https://example.com/new-metadata.json.' },
      },
      {
        name: '{{user2}}',
        content: {
          text: 'I will update Hive 123 with the new metadata URI. Let me verify ownership and execute the update.',
          actions: ['UPDATE_HIVE_URI'],
        },
      },
    ],
    [
      {
        name: '{{user1}}',
        content: { text: 'Change the metadata for Hive ID 456 to ipfs://QmNewHash123...' },
      },
      {
        name: '{{user2}}',
        content: {
          text: 'Updating Hive 456 metadata to the new IPFS URI.',
          actions: ['UPDATE_HIVE_URI'],
        },
      },
    ],
    [
      {
        name: '{{user1}}',
        content: { text: 'Set the URI for my Hive 789 to an empty string for now.' },
      },
      {
        name: '{{user2}}',
        content: {
          text: 'Setting Hive 789 URI to empty string as requested.',
          actions: ['UPDATE_HIVE_URI'],
        },
      },
    ],
