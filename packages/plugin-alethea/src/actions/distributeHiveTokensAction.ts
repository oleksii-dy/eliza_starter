...
export const distributeHiveTokensAction: Action = {
  name: 'DISTRIBUTE_HIVE_TOKENS',
  similes: ['HIVE_TOKEN_AIRDROP', 'DISTRIBUTE_HIVE_TOKENS', 'SEND_TOKENS_FROM_HIVE'],
  description:
    ...
    [
      {
        name: '{{user1}}',
        content: {
          text: 'Airdrop 1000 tokens to 0x123...abc from Hive 42 using token 0x789...ghi',
        },
      },
      {
        name: '{{user2}}',
        content: {
          text: 'Distributing Hive utility tokens to the specified recipients.',
          actions: ['DISTRIBUTE_HIVE_TOKENS'],
        },
      },
    ],
    [
      {
        name: '{{user1}}',
        content: {
          text: 'Distribute utility tokens from Hive 123 to 0xabc...123, sending 500 tokens.',
        },
      },
      {
        name: '{{user2}}',
        content: {
          text: 'Executing the Hive token airdrop.',
          actions: ['DISTRIBUTE_HIVE_TOKENS'],
        },
      },
    ],
    [
      {
        name: '{{user1}}',
        content: {
          text: 'I need to send tokens from Hive 77. Airdrop 50 tokens to 0xaaa...bbb and 100 to 0xccc...ddd.',
        },
      },
      {
        name: '{{user2}}',
        content: {
          text: 'Understood. Initiating the token distribution from Hive 77.',
          actions: ['DISTRIBUTE_HIVE_TOKENS'],
        },
      },
    ],
    [
      {
        name: '{{user1}}',
        content: {
          text: 'Execute a Hive token airdrop for Hive 99, sending 10 tokens to 0xeee...fff.',
        },
      },
      {
        name: '{{user2}}',
        content: {
          text: 'Okay, proceeding with the token airdrop for Hive 99.',
          actions: ['DISTRIBUTE_HIVE_TOKENS'],
        },
      },
    ],
