...
export const createHiveAction: Action = {
  name: 'CREATE_HIVE',
  similes: ['LAUNCH_HIVE', 'START_HIVE', 'ESTABLISH_HIVE', 'MAKE_HIVE', 'NEW_HIVE'],
  ...
  examples: [
    [
      {
        name: '{{user1}}',
        content: {
          text: 'Create a Hive using Pod ID 123 with metadata at https://example.com/hive-metadata.json.',
        },
      },
      {
        name: '{{user2}}',
        content: {
          text: 'I will create a new Hive using Pod ID 123 with the specified metadata URI. Let me verify Pod ownership and execute the creation.',
          actions: ['CREATE_HIVE'],
        },
      },
    ],
    [
      {
        name: '{{user1}}',
        content: {
          text: 'Make a new Hive called "AI Research Collective" using my Level 5 Pod 456, metadata should be ipfs://QmExample123...',
        },
      },
      {
        name: '{{user2}}',
        content: {
          text: 'Creating a new Hive named "AI Research Collective" using Pod 456 with IPFS metadata.',
          actions: ['CREATE_HIVE'],
        },
      },
    ],
    [
      {
        name: '{{user1}}',
        content: { text: 'Launch a Hive with Pod 789 and empty metadata for now.' },
      },
      {
        name: '{{user2}}',
        content: {
          text: 'Launching a Hive with Pod 789. I will use an empty string for metadata which can be updated later.',
          actions: ['CREATE_HIVE'],
        },
      },
    ],
