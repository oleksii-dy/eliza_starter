  ...
  handler: async (
    ...
    try {
      ...
      if (network.chainId !== 8453n) {
        logger.warn(`Warning: Expected Base Network (chainId: 8453), but connected to chainId: ${network.chainId}`);
      }
    ...
    [
      {
        name: '{{name1}}',
        content: {
          text: 'Deploy a utility token for ALI Agent 0x123abc with name "MyAgent Token" symbol "MAT" and 1000000 initial supply',
        },
      },
      {
        name: '{{name2}}',
        content: {
          text: "I'll deploy a utility token for your ALI Agent. This will create an ERC-20 token that can be used within the Alethea ecosystem.",
          action: 'DEPLOY_ALI_AGENT_TOKEN',
        },
      },
    ],
    [
      {
        name: '{{name1}}',
        content: {
          text: 'Create a token called "Dragon Token" with symbol "DRG" for agent 0x456def, initial supply 500000',
        },
      },
      {
        name: '{{name2}}',
        content: {
          text: "I'll create the Dragon Token (DRG) for your ALI Agent. This token can be used for various utilities within the Alethea ecosystem.",
          action: 'DEPLOY_ALI_AGENT_TOKEN',
        },
      },
    ],
