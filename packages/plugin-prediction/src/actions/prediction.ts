...
export const predictionAction: Action = {
    ...
    handler: async (
        ...
        elizaLogger.info(formattedPredictions);
        ...
        try {
            let predictionObject = JSON.parse(predictionJson);

            elizaLogger.info(predictionJson);
            ...
            if (predictionObject.type === "existing") {
                ...
                runtime.databaseAdapter.createPrediction({
