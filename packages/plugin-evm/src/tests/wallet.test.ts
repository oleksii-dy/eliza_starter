...
describe('Wallet Provider', () => {
  ...
  describe('Constructor', () => {
    ...
    it('should initialize with custom testnet chains', () => {
      ...
      expect(walletProvider.chains.sepolia.id).toEqual(testnetChains.sepolia.id);
      expect(walletProvider.chains.baseSepolia.id).toEqual(testnetChains.baseSepolia.id);
    });
  });
  ...
  describe('Public and Wallet Clients', () => {
    ...
    it('should generate public client for Sepolia', () => {
      ...
      expect(client.chain.id).toEqual(testnetChains.sepolia.id);
    ...
    it('should generate public client with custom RPC URL', () => {
      ...
      // Check that the chain has the custom RPC URL configured
      expect(chain.rpcUrls.custom?.http[0]).toEqual(TEST_RPC_URLS.sepolia);
    });
