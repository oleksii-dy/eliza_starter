...
export class NFTService {
  ...
  private collectionCache: Map<string, { collection: NFTCollection; timestamp: number }> =
    new Map();
  ...
  async getNFTHoldings(walletAddress: Address, chainIds?: number[]): Promise<NFTHolding[]> {
