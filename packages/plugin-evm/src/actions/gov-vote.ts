  ...
  examples: [
    ...
    [
      ...
      },
      {
        name: "assistant",
        content: {
          text: "I'll vote FOR the treasury proposal. After voting, I can monitor the results and help queue the proposal for execution if it passes.",
          action: "EVM_GOVERNANCE_VOTE",
          workflowContext: {
    ...
    [
      {
        name: "user",
        content: {
          text: "I need to vote on multiple proposals today. Start with voting FOR proposal 15",
          action: "EVM_GOVERNANCE_VOTE",
        },
      },
      {
        name: "assistant",
        content: {
          text: "I'll vote FOR proposal 15 as part of your multi-proposal voting session. After this vote, I'll help you with the remaining proposals.",
          action: "EVM_GOVERNANCE_VOTE",
          workflowContext: {
