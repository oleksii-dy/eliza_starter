  ...
  return (
    <QueryClientProvider client={queryClient}>
      <div className="p-6 space-y-6">
        <div>
          <h1 className="text-2xl font-bold mb-2">EVM Plugin Dashboard</h1>
...
/**
 * Wallet balance panel component for the plugin system
 */
...
/**
 * Recent actions panel component for the plugin system
 */
...
/**
 * Combined dashboard panel component
 */
...
export const panels: AgentPanel[] = [
  ...
  },
  {
    name: 'Wallet Balance',
    path: 'wallet',
    component: WalletPanelComponent,
    icon: 'Wallet',
    public: false,
    shortLabel: 'Wallet',
  },
  {
    name: 'Recent Actions',
    path: 'recent-actions',
    component: RecentActionsPanelComponent,
    icon: 'Activity',
    public: false,
    shortLabel: 'Actions',
  },
