  ...
  return (
    <div className="p-6 bg-card rounded-lg shadow-lg space-y-4">
      ...
      <div className="border-t pt-4">
        <h3 className="text-lg font-semibold mb-3">ETH Balance</h3>
        <div className="bg-secondary/20 p-3 rounded">
          <div className="text-2xl font-bold">{balance.eth.uiAmount.toFixed(4)} ETH</div>
          <div className="text-sm text-muted-foreground">{balance.eth.balance} wei</div>
        </div>
      </div>
