...
if (process.platform === 'win32') {
  console.error('\x1b[31m%s\x1b[0m', 'Error: Autocoder is not supported on Windows.');
  console.error('\x1b[33m%s\x1b[0m', 'Autocoder requires macOS or Linux to run properly.');
  ...
  console.error('\x1b[33m%s\x1b[0m', 'Please visit https://docs.elizaos.ai/en/docs/agents-and-tools/claude-code/overview#check-system-requirements for troubleshooting information.');
  process.exit(1);
}