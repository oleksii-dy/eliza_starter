...
/**
 * Creates a mock runtime for testing using the unified mock system
 */
...
/**
 * Creates a mock state for testing using the unified mock system
 */
...
/**
 * Creates a mock Memory object for testing using the unified mock system
 *
