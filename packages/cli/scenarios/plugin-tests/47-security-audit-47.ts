...
export const securityaudit47Scenario: Scenario = {
  id: '86ab34bf-c042-4b6a-b2f4-e84dbd750d84',
  name: 'Security Audit Workflow 47',
  ...
  actors: [
    {
      id: 'f7ebfccd-7aef-4f99-b751-90ea675b0831',
      name: 'Integration Agent',
      role: 'subject',
      script: { steps: [] },
    },
    {
      id: '2ccd1f5c-ccbf-4f73-9d42-6254e078729b',
      name: 'Test User',
      role: 'tester',
      script: {
        steps: [
          {
            type: 'message',
            content: 'Scan repository 47 for security vulnerabilities and exposed secrets.',
      },
          {
            type: 'wait',
            waitTime: 8000,
  ...
  verification: {
    ...
    expectedOutcomes: [
      {
        actorId: '2ccd1f5c-ccbf-4f73-9d42-6254e078729b',
...
export default securityaudit47Scenario;