...
export const entitymapping44Scenario: Scenario = {
  id: 'ad4ff4b5-ef48-435c-b936-308f12227ee3',
  name: 'Entity Relationship Mapping 44',
  ...
  actors: [
    {
      id: '7b166e5e-63d6-40a5-a974-a4ca3b89cc6e',
      name: 'Integration Agent',
      role: 'subject',
      script: { steps: [] },
    },
    {
      id: 'b553f61b-1a00-475e-9ab7-f737c49068ac',
      name: 'Test User',
      role: 'tester',
      script: {
        steps: [
          {
            type: 'message',
            content: 'Map all contributors and their relationships in ecosystem 44.',
      },
          {
            type: 'wait',
            waitTime: 8000,
  ...
  verification: {
    ...
    expectedOutcomes: [
      {
        actorId: 'b553f61b-1a00-475e-9ab7-f737c49068ac',
...
export default entitymapping44Scenario;