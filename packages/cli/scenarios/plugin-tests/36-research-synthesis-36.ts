...
export const researchsynthesis36Scenario: Scenario = {
  id: 'b8faf561-d6ef-4010-aed9-cedc920322ce',
  ...
  actors: [
    {
      id: 'c143cae0-d8da-4f12-9130-267063433d4a',
      name: 'Integration Agent',
      role: 'subject',
      script: { steps: [] },
    },
    {
      id: '48dd568f-f241-4623-bb7d-53194d730b53',
      name: 'Test User',
      role: 'tester',
      script: {
        steps: [
  ...
  verification: {
    ...
    expectedOutcomes: [
      {
        actorId: '48dd568f-f241-4623-bb7d-53194d730b53',
