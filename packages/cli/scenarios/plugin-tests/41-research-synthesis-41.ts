...
export const researchsynthesis41Scenario: Scenario = {
  id: '4cf4c912-9191-4401-a385-55c7a145847d',
  name: 'Research Synthesis Project 41',
  ...
  actors: [
    {
      id: 'a4f9bdd8-36b6-4aa5-9543-a9834eb46cc3',
      name: 'Integration Agent',
      role: 'subject',
      script: { steps: [] },
    },
    {
      id: '8b2ccde1-62c2-4fb8-8e85-605837101b84',
      name: 'Test User',
      role: 'tester',
      script: {
        steps: [
          {
            type: 'message',
            content: 'Research topic 41: Recent advances in distributed systems and consensus mechanisms.',
      },
          {
            type: 'wait',
            waitTime: 8000,
  ...
  verification: {
    ...
    expectedOutcomes: [
      {
        actorId: '8b2ccde1-62c2-4fb8-8e85-605837101b84',
...
export default researchsynthesis41Scenario;