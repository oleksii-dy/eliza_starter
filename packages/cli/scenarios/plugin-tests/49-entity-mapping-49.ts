...
export const entitymapping49Scenario: Scenario = {
  id: '5fd094bd-e5c6-41d9-80f0-1ca700f5cb78',
  ...
  actors: [
    {
      id: '94f77e49-8c64-4f6c-95c9-3d8120736d7e',
      name: 'Integration Agent',
      role: 'subject',
      script: { steps: [] },
    },
    {
      id: '5a429d18-f273-4212-bc22-011222b3f0dd',
      name: 'Test User',
      role: 'tester',
      script: {
        steps: [
  ...
  verification: {
    ...
    expectedOutcomes: [
      {
        actorId: '5a429d18-f273-4212-bc22-011222b3f0dd',
