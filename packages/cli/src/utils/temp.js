 ...
 */
export function getTempPath(type, filename) {
  ensureTempDirs();
 ...
 */
export function createTempDir(type, prefix) {
 ...
 */
export function cleanupTempPath(path, force = false) {
 ...
 */
export function cleanupTempType(type) {
 ...
 */
export function getTempDbPath(name) {
  if (!name) {
 ...
 */
export function getTempLogPath(name) {
  if (!name) {
 ...
 */
export function isInTempDir(path) {
  const resolvedPath = resolve(path);
  const tempBase = resolve(ELIZA_TEMP_BASE);
