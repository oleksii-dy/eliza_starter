export const CLAUDE = `# ElizaOS Plugin Migration Guide (0.x to 1.x)
...
- Save <task>_<iteration>.txt in the /progress folder
- Write a summary of the task and the progress in the <task>_<iteration>.txt file whenever a task is started or completed`;
