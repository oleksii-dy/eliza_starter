...
setup() {
  ...
  export LOCAL_SMALL_MODEL="Qwen3-1.7B-Q4_0.gguf"
  export LOCAL_MEDIUM_MODEL="Qwen3-1.7B-Q4_0.gguf"
...
@test "send message to Ada agent and get a response" {
  ...
  local payload="{\"entityId\":\"31c75add-3a49-4bb1-ad40-92c6b4c39558\",\"roomId\":\"$ELIZA_AGENT_ID\",\"source\":\"client_chat\",\"text\":\"What's your stance on AI regulation?\",\"channelType\":\"API\"}"
