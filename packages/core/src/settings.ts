...
nexLogger.info("Loading embedding settings:", {
...
nexLogger.debug("Loading character settings:", {
...
export function loadEnvConfig(): Settings {
    ...
    if (!result.error) {
        nexLogger.log(`Loaded .env file from: ${envPath}`);
    }
...
nexLogger.info("Parsed settings:", {
