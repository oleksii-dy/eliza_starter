...
export abstract class WalletServiceAdapter extends Service implements IUniversalWalletService {
  ...
  abstract getUniversalBalance(
    assetAddress: string,
    owner?: string
  ): Promise<UniversalTokenBalance>;
