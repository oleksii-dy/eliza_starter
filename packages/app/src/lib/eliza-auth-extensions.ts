...
export const checkUserPermissionAction: Action = {
  ...
  handler: async (
    ...
    const rolePermissions: Record<string, string[]> = {
      ...
      admin: ['create_agents', 'delete_agents', 'manage_users', 'view_billing', 'manage_settings'],
      member: ['create_agents', 'view_agents', 'edit_own_agents'],
      viewer: ['view_agents'],
    };
...
export const platformAuthPlugin: Plugin = {
  ...
  providers: [platformAuthProvider, organizationContextProvider],
  actions: [checkUserPermissionAction, getUserContextAction],
  evaluators: [securityContextEvaluator],
};
