  ...
  tests: [
     ...
     */
    {
      ...
      fn: async (runtime) => {
        ...
        console.log(`✅ Action validation works correctly, connected: ${service.isConnected()}, valid: ${isValid}`);
      },
    },
     ...
     */
    {
      ...
      fn: async (runtime) => {
        ...
        console.log(`✅ Plugin configuration verified: ${plugin.actions.length} actions, ${plugin.providers.length} providers`);
      },
    },
  ],
};
