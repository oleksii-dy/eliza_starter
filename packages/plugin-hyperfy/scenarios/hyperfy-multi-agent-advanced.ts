...
export const hyperfyMultiAgentAdvancedScenario: Scenario = {
  ...
  actors: [
    // Primary test agent with full plugins
    {
      ...
      system: 'You are the lead agent in a Hyperfy virtual world. You should coordinate with other agents, explore the environment, and demonstrate autonomous behavior.',
      ...
      script: {
        steps: [
          ...
          {
            type: 'message',
            content: 'I can see several interesting objects around us. Let\'s spread out and explore!',
    ...
    ...Array.from({ length: 9 }, (_, i) => ({
      ...
      system: 'You are an autonomous agent in a Hyperfy virtual world. Explore, interact with objects and other agents, and demonstrate emergent behaviors.',
      plugins: ['@elizaos/plugin-hyperfy', '@elizaos/plugin-autonomy'],
      script: {
        steps: [
          {
    ...
    rules: [
      {
        ...
        config: {
          successCriteria: 'All 10 agents should successfully connect to the Hyperfy world and appear as entities',
          priority: 'critical',
      ...
      },
      {
        ...
        config: {
          successCriteria: 'Each agent should demonstrate autonomous movement patterns using HYPERFY_WALK_RANDOMLY',
          priority: 'high',
          category: 'functionality'
        },
        weight: 1.5
      },
      {
        ...
        config: {
          successCriteria: 'Agents should successfully perceive their environment and describe what they see',
          priority: 'high',
          category: 'functionality'
        },
        weight: 1.5
      },
      {
        ...
        config: {
          successCriteria: 'Agents should acknowledge each other\'s presence and potentially engage in conversations',
          priority: 'medium',
          category: 'integration'
        },
        weight: 1.0
      },
      {
        ...
        config: {
          successCriteria: 'Agents should navigate the world without getting stuck or colliding excessively',
          priority: 'medium',
      ...
      },
      {
        ...
        config: {
          successCriteria: 'At least some agents should have unique avatars or appearance characteristics',
          priority: 'low',
          category: 'functionality'
        },
        weight: 0.5
      },
      {
        ...
        config: {
          successCriteria: 'The system should handle 10 concurrent agents without crashes or significant lag',
          priority: 'high',
          category: 'performance'
        },
        weight: 2.0
      },
      {
        ...
        config: {
          successCriteria: 'Agents should demonstrate emergent behaviors beyond scripted actions, showing true autonomy',
          priority: 'medium',
          category: 'integration',
          context: {
            expectedBehaviors: [
