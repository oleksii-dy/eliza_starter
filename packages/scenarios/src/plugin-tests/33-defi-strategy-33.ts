...
export const defistrategy33Scenario: Scenario = {
  id: '6e0ad735-cf69-4eba-8782-e24c84ec58ce',
  name: 'DeFi Strategy Optimization 33',
  ...
  actors: [
    {
      id: '3427b143-a201-4185-a048-17633a0c735e',
      name: 'Integration Agent',
      role: 'subject',
      script: { steps: [] },
    },
    {
      id: '1d8e0175-d21f-44e0-8597-109befbe5db7',
      name: 'Test User',
      role: 'subject',
      script: {
        steps: [
          {
            type: 'message',
            content: 'Analyze yield opportunities in protocol 33 across different chains.',
      },
          {
            type: 'wait',
            waitTime: 8000,
  ...
  verification: {
    ...
    expectedOutcomes: [
      {
        actorId: '1d8e0175-d21f-44e0-8597-109befbe5db7',
...
export default defistrategy33Scenario;