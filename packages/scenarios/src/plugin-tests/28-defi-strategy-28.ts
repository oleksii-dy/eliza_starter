...
export const defistrategy28Scenario: Scenario = {
  id: '3d8a5102-209b-46f7-a856-5a78e5cb2ab4',
  name: 'DeFi Strategy Optimization 28',
  ...
  actors: [
    {
      id: '9771bd2e-25e0-4277-9ce9-a2ecc1dc9d14',
      name: 'Integration Agent',
      role: 'subject',
      script: { steps: [] },
    },
    {
      id: 'ecfe383b-1e7d-4922-b09b-fa05f1523643',
      name: 'Test User',
      role: 'subject',
      script: {
        steps: [
          {
            type: 'message',
            content: 'Analyze yield opportunities in protocol 28 across different chains.',
      },
          {
            type: 'wait',
            waitTime: 8000,
  ...
  verification: {
    ...
    expectedOutcomes: [
      {
        actorId: 'ecfe383b-1e7d-4922-b09b-fa05f1523643',
...
export default defistrategy28Scenario;