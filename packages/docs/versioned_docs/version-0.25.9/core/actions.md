...
You can find these samples in the plugin-message-handling package: https://github.com/elizaOS/eliza/tree/main/packages/plugin-message-handling/src/actions
