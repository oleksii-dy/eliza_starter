...
| **Memory Systems**    | Creates, retrieves, and embeds memories and manages conversation history.                                                                                                               | [Memory API](/api/interfaces/Memory)                              | [`memory.ts`](https://github.com/elizaos/runtime/memory.ts)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    |
...
| **Cache Management**  | Provides flexible storage and retrieval via various caching methods.                                                                                                                    | [Cache API](/api/interfaces/IDatabaseAdapter#cache-methods)       | [`cache.ts`](https://github.com/elizaos/runtime/cache.ts)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
...
interface IAgentRuntime {
    ...
    services: Map<ServiceType, Service>;       // Platform connections and functionality
    ...
    createRunId(): UUID;                           // Create a new run ID
    startRun(): UUID;                              // Start a new run and return its ID
    endRun(): void;                                // End the current run
    getCurrentRunId(): UUID;                       // Get the current run ID
}
```
...
- **`createRunId()` / `startRun()` / `endRun()` / `getCurrentRunId()`**: Manages run tracking for agent operations.
