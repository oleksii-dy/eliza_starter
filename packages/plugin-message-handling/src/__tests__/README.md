...
```bash
npx vitest run packages/plugin-message-handilng/__tests__
```

Run specific test file:

```bash
npx vitest run packages/plugin-message-handilng/__tests__/actions.test.ts
```

Run tests in watch mode:

```bash
npx vitest watch packages/plugin-message-handilng/__tests__
```
