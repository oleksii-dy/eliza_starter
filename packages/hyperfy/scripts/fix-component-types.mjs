...
const fixes = [
  // Import statements
  {
    ...
    replacement: (match, imports) => {
      const newImports = imports.includes('InventoryComponent') ? imports : 
  ...
  { pattern: /\.getComponent\('construction_site'\)/g, replacement: ".getComponent<ConstructionSiteComponent>('construction_site')" },
