  ...
  const timeoutFeatures = [
    {
      ...
      checks: [
        ...
        {
          pattern: 'testAbortControllers: Map<string, AbortController>',
          description: 'Abort controller tracking exists',
        },
    ...
    },
    {
      ...
      checks: [
        ...
        {
          pattern: '35000\\);.*35 second timeout for movement test',
          description: 'Movement test has 35s timeout (longest)',
        },
      ],
    },
    {
    ...
    },
    {
      ...
      checks: [
        {
          pattern: 'this\\.testTimeouts\\.forEach\\(\\(timeout, scenarioId\\)',
          description: 'Destroy clears all timeouts',
        },
        {
          pattern: 'this\\.testAbortControllers\\.forEach\\(\\(controller, scenarioId\\)',
          description: 'Destroy aborts all controllers',
        },
