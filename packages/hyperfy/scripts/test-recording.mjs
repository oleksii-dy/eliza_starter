      ...
      worldDetails: (() => {
        if (window.world) {
          return {
            ...
            sceneChildren:
              window.world.graphics && window.world.graphics.scene ? window.world.graphics.scene.children.length : 0,
          }
        }
        return null
      })(),
  ...
  if (!debugInfo.worldDetails?.hasScene) {
    ...
    const secondCheck = await page.evaluate(() => {
      return {
        ...
        sceneChildren:
          window.world && window.world.graphics && window.world.graphics.scene
            ? window.world.graphics.scene.children.length
            : 0,
