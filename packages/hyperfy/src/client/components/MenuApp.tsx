...
function MenuAppIndex({ world, app, blueprint, _pop, push }) {
  ...
  return (
    <>
      ...
      {!frozen && (
        <MenuItemBtn label="Code" hint="View or edit the code for this app" onClick={world.ui.toggleCode} nav={false} />
      )}
      ...
      <MenuItemBtn label="Download" hint="Download this app as a .hyp file" onClick={download} nav={false} />
      <MenuItemBtn
        label="Delete"
...
function MenuItemField({ world, props, field, value, modify }) {
  ...
  if (field.type === 'button') {
    return <MenuItemBtn label={field.label} hint={field.hint} onClick={field.onClick} nav={false} />;
  }
  return null;
}
