...
export function MenuItemNumber({ label, hint, dp = 0, min = -Infinity, max = Infinity, step = 1, value, onChange }) {
  ...
  return (
    ...
    >
      ...
      `}</style>
      <div
        className="menuitemnumber-label"
        style={{
          width: '9.4rem',
          flexShrink: 0,
          whiteSpace: 'nowrap',
...
export function MenuItemSwitch({ label, hint, options, value, onChange }) {
  ...
  return (
    ...
    >
      ...
      `}</style>
      <div
        className="menuitemswitch-label"
        style={{
          flex: 1,
          whiteSpace: 'nowrap',
          textOverflow: 'ellipsis',
      ...
      <div
        className="menuitemswitch-btn left"
        onClick={prev}
        style={{
          display: 'flex',
          alignItems: 'center',
      ...
      <div
        className="menuitemswitch-btn right"
        onClick={next}
        style={{
          display: 'flex',
          alignItems: 'center',
...
export function MenuItemFileBtn({ label, hint, accept, value, onChange }) {
  ...
  return (
    ...
    >
      ...
      `}</style>
      <div
        className="menuitemfilebtn-label"
        style={{
          width: '9.4rem',
          flexShrink: 0,
        }}
...
export function MenuItemFile({ world, label, hint, kind: kindName, value, onChange }) {
  ...
  return (
    ...
    >
      ...
      {!value && !loading && (
        <div
          className="menuitemfile-placeholder"
          style={{
      ...
      {loading && (
        <div
          className="menuitemfile-loading"
          style={{
...
export function MenuItemToggle({ label, hint, trueLabel = 'Yes', falseLabel = 'No', value, onChange }) {
  ...
  return (
    ...
    >
      ...
      `}</style>
      <div
        className="menuitemtoggle-label"
        style={{
          flex: 1,
          whiteSpace: 'nowrap',
          textOverflow: 'ellipsis',
