...
export class UIText extends Node {
  ...
  set value(val) {
    if (val === undefined) val = defaults.value
    if (isNumber(val)) {
      val = val + ''
    }
    if (!isString(val)) {
  ...
  set fontSize(value) {
    if (value === undefined) value = defaults.fontSize
    if (!isNumber(value)) {
  ...
  set lineHeight(value) {
    if (value === undefined) value = defaults.lineHeight
    if (!isNumber(value)) {
  ...
  set textAlign(value) {
    if (value === undefined) value = defaults.textAlign
  ...
  set fontFamily(value) {
    if (value === undefined) value = defaults.fontFamily
    if (!isString(value)) {
  ...
  set fontWeight(value) {
    if (value === undefined) value = defaults.fontWeight
  ...
  set flexBasis(value) {
    if (value === undefined) value = defaults.flexBasis
  ...
  set flexGrow(value) {
    if (value === undefined) value = defaults.flexGrow
    if (!isNumber(value)) {
  ...
  set flexShrink(value) {
    if (value === undefined) value = defaults.flexShrink
    if (!isNumber(value)) {
