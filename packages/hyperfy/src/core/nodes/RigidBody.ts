...
export class RigidBody extends Node {
  ...
  set mass(value) {
    if (value === undefined) {value = defaults.mass;}
    if (!isNumber(value)) {
  ...
  set linearDamping(value) {
    if (value === undefined) {value = defaults.linearDamping;}
    if (!isNumber(value)) {
  ...
  set angularDamping(value) {
    if (value === undefined) {value = defaults.angularDamping;}
    if (!isNumber(value)) {
  ...
  set tag(value) {
    if (value === undefined) {value = defaults.tag;}
    if (isNumber(value)) {
      value = `${value}`;
    }
  ...
  set onContactStart(value) {
    if (value === undefined) {value = defaults.onContactStart;}
  ...
  set onContactEnd(value) {
    if (value === undefined) {value = defaults.onContactEnd;}
    if (value !== null && !isFunction(value)) {
  ...
  set onTriggerEnter(value) {
    if (value === undefined) {value = defaults.onTriggerEnter;}
    if (value !== null && !isFunction(value)) {
  ...
  set onTriggerLeave(value) {
    if (value === undefined) {value = defaults.onTriggerLeave;}
    if (value !== null && !isFunction(value)) {
