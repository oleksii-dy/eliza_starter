...
export class Action extends Node {
  ...
  set distance(value: number) {
    if (!value && value !== 0) {value = defaults.distance;}
    if (!isNumber(value)) {
  ...
  set duration(value: number) {
    if (!value && value !== 0) {value = defaults.duration;}
    if (!isNumber(value)) {
  ...
  set onStart(value: any) {
    if (!value) {value = defaults.onStart;}
    if (!isFunction(value)) {
  ...
  set onTrigger(value: any) {
    if (!value) {value = defaults.onTrigger;}
    if (!isFunction(value)) {
  ...
  set onCancel(value: any) {
    if (!value) {value = defaults.onCancel;}
    if (!isFunction(value)) {
