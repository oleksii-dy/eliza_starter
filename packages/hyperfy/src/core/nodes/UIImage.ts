...
export class UIImage extends Node {
  // Private properties
  private _display: string = defaults.display
  private _src: string | null = defaults.src
  private _width: number | null = defaults.width
  private _height: number | null = defaults.height
  private _absolute: boolean = defaults.absolute
  private _top: number | null = defaults.top
  private _right: number | null = defaults.right
  private _bottom: number | null = defaults.bottom
  private _left: number | null = defaults.left
  private _objectFit: string = defaults.objectFit
  private _backgroundColor: string | null = defaults.backgroundColor
  private _borderRadius: number = defaults.borderRadius
  private _margin: number | number[] = defaults.margin
  ...
  mount() {
    ...
    if (this.parent) {
      (this.parent as any).yogaNode.insertChild(this.yogaNode, (this.parent as any).yogaNode.getChildCount())
    }
  ...
  unmount() {
    ...
    if (this.yogaNode) {
      if (this.parent) {
        (this.parent as any).yogaNode?.removeChild(this.yogaNode)
      }
      this.yogaNode.free()
      this.yogaNode = null
      this.box = null
  ...
  set display(value) {
    if (value === undefined) value = defaults.display
    if (!isDisplay(value)) {
  ...
  set top(value) {
    ...
    if (this.yogaNode && this.ui) {
      this.yogaNode.setPosition(Yoga.EDGE_TOP, isNum && this._top !== null ? this._top * this.ui._res : undefined)
    }
    this.ui?.redraw()
  }
  ...
  set right(value) {
    ...
    this._right = value
    if (this.yogaNode && this.ui) {
      this.yogaNode.setPosition(Yoga.EDGE_RIGHT, isNum && this._right !== null ? this._right * this.ui._res : undefined)
    }
    this.ui?.redraw()
  }
  ...
  set bottom(value) {
    ...
    this._bottom = value
    if (this.yogaNode && this.ui) {
      this.yogaNode.setPosition(Yoga.EDGE_BOTTOM, isNum && this._bottom !== null ? this._bottom * this.ui._res : undefined)
    }
    this.ui?.redraw()
  }
  ...
  set left(value) {
    ...
    this._left = value
    if (this.yogaNode && this.ui) {
      this.yogaNode.setPosition(Yoga.EDGE_LEFT, isNum && this._left !== null ? this._left * this.ui._res : undefined)
    }
    this.ui?.redraw()
  }
  ...
  set objectFit(value) {
    if (value === undefined) value = defaults.objectFit
  ...
  set borderRadius(value) {
    if (value === undefined) value = defaults.borderRadius
    if (!isNumber(value)) {
