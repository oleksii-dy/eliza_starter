...
describe('Stage System', () => {
  ...
  describe('instanced rendering', () => {
    it('should batch multiple instances of same mesh', () => {
      ...
      const instancedMeshes = stage.scene.children.filter(c => c instanceof InstancedMesh)
    ...
    it('should handle instance removal', () => {
      ...
      const instancedMesh = stage.scene.children.find(c => c instanceof InstancedMesh) as InstancedMesh
