...
export class TestWorld extends World {
  ...
  override getSystem<T extends System>(name: string): T | undefined {
    switch (name) {
      case 'events': return this.events as unknown as T;
      case 'entities': return this.entities as unknown as T;
      case 'network': return this.network as unknown as T;
      case 'spatialIndex': return this.spatialIndex as unknown as T;
      case 'terrain': return this.terrain as unknown as T;
      case 'time': return this.timeSystem as unknown as T;
      case 'combat': return this.combat as unknown as T;
      case 'inventory': return this.inventory as unknown as T;
      case 'loot': return this.loot as unknown as T;
      case 'movement': return this.movement as unknown as T;
      case 'npc': return this.npc as unknown as T;
      case 'quest': return this.quest as unknown as T;
      case 'skills': return this.skills as unknown as T;
      case 'spawning': return this.spawning as unknown as T;
      default: return super.getSystem<T>(name);
    }
  }
