---
title: AI Documentation Assistant Configuration
description: Configure AI-powered features in the ElizaOS documentation for enhanced search, recommendations, and interactive assistance
---
