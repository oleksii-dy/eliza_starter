...
export const agentSelfModificationScenario: PluginScenario = {
  ...
  script: {
    steps: [
      ...
      },
      {
        ...
        type: 'message',
        from: 'User',
        content: 'You should remember that you are particularly good at making technical topics accessible',
  ...
  setup: {
    ...
    context: 'User is providing feedback about the agent\'s teaching style that should trigger self-reflection and evolution'
  }
};
