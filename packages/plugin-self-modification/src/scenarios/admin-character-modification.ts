...
export const adminCharacterModificationScenario: PluginScenario = {
  ...
  script: {
    steps: [
      ...
      },
      {
        ...
        type: 'message',
        from: 'Admin User',
        content: 'Add "educational technology" to your topics and "patient" to your personality traits',
  ...
  setup: {
    ...
    context: 'Admin is requesting character modifications to improve the agent\'s teaching capabilities'
  }
};
