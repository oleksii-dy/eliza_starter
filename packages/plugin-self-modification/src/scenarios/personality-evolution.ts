...
export const personalityEvolutionScenario: PluginScenario = {
  ...
  description: 'Test agent gradually evolving its personality based on consistent positive feedback patterns',
  ...
  setup: {
    ...
    context: 'User is providing consistent positive feedback that should trigger gradual personality evolution toward more encouraging behavior'
  }
};
