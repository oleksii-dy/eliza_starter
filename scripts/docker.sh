...
case "$1" in
    ...
    run)
        ...
        docker run --platform linux/amd64 -p 3000:3000 -d \
            ...
            -v "$(pwd)/packages/client-farcaster/src:/app/packages/client-farcaster/src" \
            ...
            -v "$(pwd)/packages/plugin-tee/src:/app/packages/plugin-tee/src" \
